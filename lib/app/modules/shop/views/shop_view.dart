                    ...
                    slivers: <Widget>[
                      SliverAppBar(
                        ...
                        actions: <Widget>[
                          new IconButton(
                              onPressed: () {
                                print("Search Button Pressed");
                                if (controller.actionIcon.value.icon ==
                                    Icons.search) {
                                  print("Search Button Pressed");
                                  controller.actionIcon.value = new Icon(
                                      Icons.close,
                                      color: Colors.white);
                                  controller.isSearching.value = true;
                                } else {
                      ...
                      SliverGrid(
                        ...
                        delegate: SliverChildBuilderDelegate(
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  ...
                                  children: [
                                    ...
                                    Text(controller.mappedItems.value
                                        .elementAt(index)
                                        .name),
                                    Text((controller.mappedItems.value
                                                .elementAt(index)
                          ...
                          childCount: controller.mappedItems.value.length,
                        ),
                      ),
                    ],
                  )
